...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        ...
        if (strRoles == null) {
        	...
        	System.out.println("Role is:"+ERole.ROLE_USER);
        	System.out.println("Role is:"+roleRepository.findByName(ERole.ROLE_USER));
            ...
            strRoles.forEach(role -> {
                switch (role) {
                    case "admin":
                    	...
                    	System.out.println("Role is:"+ERole.ROLE_ADMIN);
                    	System.out.println("Role is:"+roleRepository.findByName(ERole.ROLE_ADMIN));
