...
public class MovieServiceTest {
    ...
    void getMovieByName() {
        // Set up mock data
        List<Movie> movies = new ArrayList<>();
        movies.add(new Movie("Shakuntalam", "Inox", 157, "Book ASAP"));
        movies.add(new Movie("The Matrix", "Hollywood", 153, "Experience the action"));
        movies.add(new Movie("Pathaan", "Bollywood", 128, "Book ASAP"));
