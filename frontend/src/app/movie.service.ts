...
export class MovieService {
  urlForGetAllMovies: string =
    'http://localhost:8081/api/v1.0/moviebooking/all';
  urlForGetMovieByName: string =
    'http://localhost:8081/api/v1.0/moviebooking/movies/search/';
  urlForRegisterAUser: string =
    'http://localhost:8081/api/v1.0/moviebooking/register';
  urlForLogin: string = 'http://localhost:8081/api/v1.0/moviebooking/login';
  urlForBookingAMovie: string = 'http://localhost:8081/api/v1.0/moviebooking/';
  urlForPasswordReset: string = 'http://localhost:8081/api/v1.0/moviebooking/';
  urlForUpdatedAMovieStatus: string =
    'http://localhost:8081/api/v1.0/moviebooking/';
  urlForDeletingAMovie: string = 'http://localhost:8081/api/v1.0/moviebooking/';
  urlForAllTicketsBooked: string =
    'http://localhost:8081/api/v1.0/moviebooking/getallbookedtickets/';
  ...
  bookTickets(ticket: Ticket): Observable<Message> {
    return this.httpClient.post<Message>(
      this.urlForBookingAMovie + ticket.movieName + '/book',
      ticket,
